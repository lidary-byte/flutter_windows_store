...
import 'package:flutter_windows_store/page/app/app_update_page.dart';
...
class RouterPages {
  ...
  static const appManagePageRouter = '/app_manage_page';
  ...
  static final List<GetPage> getPages = [
    ...
    GetPage(name: appManagePageRouter, page: () => AppUpdatePage()),
  ];
}
